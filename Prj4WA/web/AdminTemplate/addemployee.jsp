<%-- 
    ...
    Created on : Jul 13, 2020, 4:05:55 PM
    Author     : ADMIN
--%>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Add new Employee</small></h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                         ...
                                         <select name="dropdown" class="form-group">
                                            <option value="Java" selected>Admin</option>
                                            <option value="Ruby">Employee</option>
                                        </select>
                                        </div>
                                    </div>
                                    <!-- /.card-body -->
