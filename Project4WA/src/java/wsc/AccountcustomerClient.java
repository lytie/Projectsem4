...
/**
 * Jersey REST client generated for REST resource:AccountcustomerFacadeREST
 * [entities.accountcustomer]<br>
 * USAGE:
 * <pre>
...
public class AccountcustomerClient {
    ...
    public AccountcustomerClient() {
        ...
        webTarget = client.target(BASE_URI).path("entities.accountcustomer");
    }
