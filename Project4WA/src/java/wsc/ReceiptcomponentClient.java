...
/**
 * Jersey REST client generated for REST resource:ReceiptcomponentFacadeREST
 * [entities.receiptcomponent]<br>
 * USAGE:
 * <pre>
 ...
 * @author Admin
 */
public class ReceiptcomponentClient {
    private WebTarget webTarget;
    private Client client;
    private static final String BASE_URI = "http://localhost:8080/Project4WS/webresources";

    public ReceiptcomponentClient() {
        client = javax.ws.rs.client.ClientBuilder.newClient();
        webTarget = client.target(BASE_URI).path("entities.receiptcomponent");
    }
