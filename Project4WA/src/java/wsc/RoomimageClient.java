...
/**
 * Jersey REST client generated for REST resource:RoomimageFacadeREST
 * [entities.roomimage]<br>
 * USAGE:
 * <pre>
 *        RoomimageClient client = new RoomimageClient();
 ...
 * @author Admin
 */
public class RoomimageClient {
    private WebTarget webTarget;
    private Client client;
    private static final String BASE_URI = "http://localhost:8080/Project4WS/webresources";

    public RoomimageClient() {
        client = javax.ws.rs.client.ClientBuilder.newClient();
        webTarget = client.target(BASE_URI).path("entities.roomimage");
    }
