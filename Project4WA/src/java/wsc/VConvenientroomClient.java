...
/**
 * Jersey REST client generated for REST resource:VConvenientroomFacadeREST
 * [entities.vconvenientroom]<br>
 * USAGE:
 * <pre>
 *        VConvenientroomClient client = new VConvenientroomClient();
 ...
 * @author Admin
 */
public class VConvenientroomClient {
    private WebTarget webTarget;
    private Client client;
    private static final String BASE_URI = "http://localhost:8080/Project4WS/webresources";

    public VConvenientroomClient() {
        client = javax.ws.rs.client.ClientBuilder.newClient();
        webTarget = client.target(BASE_URI).path("entities.vconvenientroom");
    }
