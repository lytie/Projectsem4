            ...
            <aside class="main-sidebar sidebar-dark-primary elevation-4">
                ...
                <div class="sidebar">
                    ...
                    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                        ...
                        <div class="info">
                            <a href="index.html" class="d-block">HOME PAGE</a>
                        </div>
                    </div>
                   ...
                   with font-awesome or any other icon font library -->
                            ...
                            <li class="nav-item has-treeview">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="roomImage.html" class="nav-link">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Room Image</p>
                                        </a>
                                    </li>
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="roomtype.html" class="nav-link">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Room Type</p>
                                        </a>
                                    </li>
                            ...
                            <li class="nav-item has-treeview">
                                <a href="convenient.html" class="nav-link">
