			...
			<div class="row p-t-108 p-b-70">		
				...
				<div class="col-md-6 blo3 flex-w flex-col-l-sm m-b-30">
						...
						<div class="text-blo3 size21 flex-col-l-m">
							...
							<span class="txt22 m-t-20">
								$29.79 <a href="" class="btn btn-outline-warning "  >Add to orders</a>
							</span>
						</div>
				...
				<div class="col-md-6 blo3 flex-w flex-col-l-sm m-b-30">
						...
						<div class="text-blo3 size21 flex-col-l-m">
							...
							<span class="txt22 m-t-20">
								$45.09 <a href="" class="btn btn-outline-warning "  >Add to orders</a>
							</span>
						</div>
				...
				<div class="col-md-6 blo3 flex-w flex-col-l-sm m-b-30">
						...
						<div class="text-blo3 size21 flex-col-l-m">
							...
							<span class="txt22 m-t-20">
								$12.75 <a href="" class="btn btn-outline-warning "  >Add to orders</a>
							</span>
						</div>
				</div>
				<!-- Block3 -->
