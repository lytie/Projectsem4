 ...
 * @author ADMIN
 */
public class Admin_RoomImage extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            GenericType<List<Roomimage>> typ = new GenericType<List<Roomimage>>() {
            };
            List<Roomimage> listimg = roomimageClient.findAll_JSON(typ);
            request.setAttribute("listimg", listimg);

             request.getRequestDispatcher("AdminTemplate/roomImage.jsp").forward(request, response);
        }
    }
