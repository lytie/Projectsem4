...
/**
 * Jersey REST client generated for REST resource:HistoryFacadeREST
 * [entities.history]<br>
 * USAGE:
 * <pre>
...
public class HistoryClient {
    ...
    public HistoryClient() {
        ...
        webTarget = client.target(BASE_URI).path("entities.history");
    }
    ...
    public <T> T findHistory_XML(javax.ws.rs.core.GenericType<T> responseType) throws ClientErrorException {
        WebTarget resource = webTarget;
        resource = resource.path("findHistory");
        return resource.request(javax.ws.rs.core.MediaType.APPLICATION_XML).get(responseType);
    }

    public <T> T findHistory_JSON(javax.ws.rs.core.GenericType<T> responseType) throws ClientErrorException {
        WebTarget resource = webTarget;
        resource = resource.path("findHistory");
        return resource.request(javax.ws.rs.core.MediaType.APPLICATION_JSON).get(responseType);
    }
