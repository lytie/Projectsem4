...
/**
 * Jersey REST client generated for REST resource:RoomconvenientFacadeREST
 * [entities.roomconvenient]<br>
 * USAGE:
 * <pre>
 *        RoomconvenientClient client = new RoomconvenientClient();
 ...
 * @author Admin
 */
public class RoomconvenientClient {
    private WebTarget webTarget;
    private Client client;
    private static final String BASE_URI = "http://localhost:8080/WS/webresources";

    public RoomconvenientClient() {
        client = javax.ws.rs.client.ClientBuilder.newClient();
        webTarget = client.target(BASE_URI).path("entities.roomconvenient");
    }
