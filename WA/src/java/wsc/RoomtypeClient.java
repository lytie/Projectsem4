...
/**
 * Jersey REST client generated for REST resource:RoomtypeFacadeREST
 * [entities.roomtype]<br>
 * USAGE:
 * <pre>
...
public class RoomtypeClient {
    ...
    public RoomtypeClient() {
        client = javax.ws.rs.client.ClientBuilder.newClient();
        webTarget = client.target(BASE_URI).path("entities.roomtype");
    }

    public <T> T topType_XML(javax.ws.rs.core.GenericType<T> responseType) throws ClientErrorException {
        WebTarget resource = webTarget;
        resource = resource.path("topType");
        return resource.request(javax.ws.rs.core.MediaType.APPLICATION_XML).get(responseType);
    }

    public <T> T topType_JSON(javax.ws.rs.core.GenericType<T> responseType) throws ClientErrorException {
        WebTarget resource = webTarget;
        resource = resource.path("topType");
