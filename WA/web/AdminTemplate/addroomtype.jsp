                                    ...
                                    <form role="form" id="quickForm">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="number" class="form-control" id="exampleInputFullName" placeholder="Bed Option">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <label for="exampleInputPassword1">RoomSize :</label>
                                                <input type="number" name="number" class="form-control" id="exampleInputFullName" placeholder="RoomSize">
                                            </div>
