function getLazarSoftScanner() {
    ...
    function r(e, t, n, r, i, a) {
        ...
        this.totalCodewords = o, this.__defineGetter__("VersionNumber", function() {
            ...
            var e = this.DimensionForVersion, t = new v(e);
    ...
    function i(e, t, n, r, a, o, s, h, w) {
        this.a11 = e, this.a12 = r, this.a13 = s, this.a21 = t, this.a22 = a, this.a23 = h, this.a31 = n, this.a32 = o, this.a33 = w, this.transformPoints1 = function(e) {
            for (var t = e.length, n = this.a11, r = this.a12, i = this.a13, a = this.a21, o = this.a22, s = this.a23, h = this.a31, w = this.a32, f = this.a33, u = 0; u < t; u += 2) {
                var d = e[u], l = e[u + 1], c = i * d + s * l + f;
                e[u] = (n * d + a * l + h) / c, e[u + 1] = (r * d + o * l + w) / c
            }
        }, this.transformPoints2 = function(e, t) {
            for (var n = e.length, r = 0; r < n; r++) {
                var i = e[r], a = t[r], o = this.a13 * i + this.a23 * a + this.a33;
    ...
    function o(t) {
        this.image = t, this.resultPointCallback = null, this.sizeOfBlackWhiteBlackRun = function(e, t, n, r) {
            ...
            var i = this.sizeOfBlackWhiteBlackRun(e, t, n, r), a = 1, o = e - (n - e);
            ...
            var i = Math.floor(r * e), a = Math.max(0, t - i), o = Math.min(A.width - 1, t + i);
            if (o - a < 3 * e)
                throw"Error";
            var s = Math.max(0, n - i), h = Math.min(A.height - 1, n + i);
            ...
            var t = e.TopLeft, n = e.TopRight, i = e.BottomLeft, o = this.calculateModuleSize(t, n, i);
            if (o < 1)
                throw"Error";
            var s = this.computeDimension(t, n, i, o), h = r.getProvisionalVersionForDimension(s), w = h.DimensionForVersion - 7, f = null;
    ...
    e.checkAndNudgePoints = function(e, t) {
        for (var n = A.width, r = A.height, i = !0, a = 0; a < t.length && i; a += 2) {
            var o = Math.floor(t[a]), s = Math.floor(t[a + 1]);
            if (o < -1 || o > n || s < -1 || s > r)
        ...
        var u = n - a, d = s - a, l = e - n + a - s, c = r - o, g = u * w - d * c, v = (l * w - d * f) / g, m = (u * f - l * c) / g;
    ...
    var u = new f(0, 1, "L"), d = new f(1, 0, "M"), l = new f(2, 3, "Q"), c = new f(3, 2, "H"), g = new Array(d, u, c, l);
    function v(e, t) {
        if (t || (t = e), e < 1 || t < 1)
    ...
    function b(e) {
        ...
        this.bitMatrix = e, this.parsedVersion = null, this.parsedFormatInfo = null, this.copyBit = function(e, t, n) {
            ...
            if (this.parsedFormatInfo = w.decodeFormatInformation(e), null != this.parsedFormatInfo)
                return this.parsedFormatInfo;
            ...
            if (this.parsedVersion = r.decodeVersionInformation(n), null != this.parsedVersion && this.parsedVersion.DimensionForVersion == e)
                return this.parsedVersion;
            n = 0;
            for (o = 5; o >= 0; o--)
                for (a = e - 9; a >= i; a--)
            ...
            var e = this.readFormatInformation(), t = this.readVersion(), n = y.forReference(e.DataMask), r = this.bitMatrix.Dimension;
            ...
            for (var i = t.buildFunctionPattern(), a = !0, o = new Array(t.TotalCodewords), s = 0, h = 0, w = 0, f = r - 1; f > 0; f -= 2) {
                ...
                for (var u = 0; u < r; u++)
                    for (var d = a ? r - 1 - u : u, l = 0; l < 2; l++)
                        i.get_Renamed(f - l, d) || (w++, h <<= 1, this.bitMatrix.get_Renamed(f - l, d) && (h |= 1), 8 == w && (o[s++] = h, w = 0, h = 0));
                a ^= !0
            }
    ...
    m.getDataBlocks = function(e, t, n) {
        ...
        for (var s = new Array(i), h = 0, w = 0; w < a.length; w++) {
            var f = a[w];
            for (o = 0; o < f.Count; o++) {
                var u = f.DataCodewords, d = r.ECCodewordsPerBlock + u;
        ...
        c++;
        var g = l - r.ECCodewordsPerBlock, v = 0;
        for (o = 0; o < g; o++)
            for (w = 0; w < h; w++)
                s[w].codewords[o] = e[v++];
        for (w = c; w < h; w++)
    ...
    function C(e, t) {
        ...
        this.__defineGetter__("Zero", function() {
            ...
            for (var t = this.field.Zero, n = this, r = e.getCoefficient(e.Degree), i = this.field.inverse(r); n.Degree >= e.Degree && !n.Zero; ) {
                var a = n.Degree - e.Degree, o = this.field.multiply(n.getCoefficient(n.Degree), i), s = e.multiplyByMonomial(a, o), h = this.field.buildMonomial(a, o);
    ...
    function _(e) {
        ...
        var i = new Array(1);
        i[0] = 1, this.one = new C(this, new Array(i)), this.__defineGetter__("Zero", function() {
            return this.zero
    ...
    }), _.QR_CODE_FIELD = new _(285), _.DATA_MATRIX_FIELD = new _(301), _.addOrSubtract = function(e, t) {
        return e ^ t
    };
    var p = {};
    p.rsDecoder = new function(e) {
        this.field = e, this.decode = function(e, t) {
            ...
            if (!a) {
                var s = new C(this.field, r), h = this.runEuclideanAlgorithm(this.field.buildMonomial(t, 1), s, t), w = h[0], f = h[1], u = this.findErrorLocations(w), d = this.findErrorMagnitudes(f, u, !1);
            ...
            for (var i = e, a = t, o = this.field.One, s = this.field.Zero, h = this.field.Zero, w = this.field.One; a.Degree >= Math.floor(n / 2); ) {
                ...
                for (var l = this.field.Zero, c = i.getCoefficient(i.Degree), g = this.field.inverse(c); a.Degree >= i.Degree && !a.Zero; ) {
                    var v = a.Degree - i.Degree, m = this.field.multiply(a.getCoefficient(a.Degree), g);
            ...
            var y = this.field.inverse(b), C = w.multiply2(y), _ = a.multiply2(y);
    ...
    }(_.QR_CODE_FIELD), p.correctErrors = function(e, t) {
        ...
        for (var h = new Array(o), w = 0, f = 0; f < a.length; f++) {
            var u = a[f], d = u.Codewords, l = u.NumDataCodewords;
            p.correctErrors(d, l);
            for (s = 0; s < l; s++)
                h[w++] = d[s]
        }
    ...
    A.imagedata = null, A.width = 0, A.height = 0, A.qrCodeSymbol = null, A.debug = !1, A.maxImgSize = 1048576, A.sizeOfDataLengthInfo = [[10, 9, 8, 8], [12, 11, 16, 10], [14, 13, 16, 12]], A.callback = null, A.vidSuccess = function(e) {
        A.localstream = e, A.webkit ? A.video.src = window.webkitURL.createObjectURL(e) : A.moz ? (A.video.mozSrcObject = e, A.video.play()) : A.video.src = e, A.gUM = !0, A.canvas_qr2 = document.createElement("canvas"), A.canvas_qr2.id = "qr-canvas", A.qrcontext2 = A.canvas_qr2.getContext("2d"), A.canvas_qr2.width = A.video.videoWidth, A.canvas_qr2.height = A.video.videoHeight, setTimeout(A.captureToCanvas, 500)
        ...
        t.getUserMedia ? t.getUserMedia({video: n, audio: !1}, A.vidSuccess, A.vidError) : t.webkitGetUserMedia ? (A.webkit = !0, t.webkitGetUserMedia({video: n, audio: !1}, A.vidSuccess, A.vidError)) : t.mozGetUserMedia && (A.moz = !0, t.mozGetUserMedia({video: n, audio: !1}, A.vidSuccess, A.vidError))
    }, A.decode = function(e) {
        if (0 == arguments.length) {
            if (A.canvas_qr2)
                var t = A.canvas_qr2, n = A.qrcontext2;
            else
        ...
        r.crossOrigin = "Anonymous", r.onload = function() {
            ...
            var n = document.createElement("canvas"), i = n.getContext("2d"), a = r.height, o = r.width;
        ...
        var t = (new Date).getTime(), n = A.grayScaleToBitmap(A.grayscale());
        if (A.debug) {
    ...
    function D() {
        this.image = null, this.possibleCenters = [], this.hasSkipped = !1, this.crossCheckStateCount = new Array(0, 0, 0, 0, 0), this.resultPointCallback = null, this.__defineGetter__("CrossCheckStateCount", function() {
            ...
            if (t < 7)
                return!1;
            var i = Math.floor((t << S) / 7), a = Math.floor(i / 2);
            ...
            var r = e[0] + e[1] + e[2] + e[3] + e[4], i = this.centerFromEnd(e, n), a = this.crossCheckVertical(t, Math.floor(i), e[2], r);
            ...
            if (e > 3) {
                ...
                this.possibleCenters.sort(function(e, t) {
                    var n = Math.abs(t.EstimatedModuleSize - a), r = Math.abs(e.EstimatedModuleSize - a);
                    return n < r ? -1 : n == r ? 0 : 1
                });
                var o = Math.sqrt(n / e - a * a), s = Math.max(.2 * a, o);
            ...
            for (var t = null, n = 0; n < e; n++) {
                ...
                if (r.Count >= B) {
                    if (null != t)
                        return this.hasSkipped = !0, Math.floor((Math.abs(t.X - r.X) - Math.abs(t.Y - r.Y)) / 2);
                    t = r
                }
            }
            return 0
            ...
            var a = t / n, o = 0;
            for (r = 0; r < n; r++)
                i = this.possibleCenters[r], o += Math.abs(i.EstimatedModuleSize - a);
            return o <= .05 * t
        }, this.findFinderPattern = function(e) {
            this.image = e;
            var t = A.height, n = A.width, r = Math.floor(3 * t / (4 * P));
            r < k && (r = k);
                    ...
                    if (e[h + o * A.width])
                        ...
                        if (4 == s)
                            if (this.foundPatternCross(a)) {
                                ...
                                a[0] = a[2], a[1] = a[3], a[2] = a[4], a[3] = 1, a[4] = 0, s = 3;
                        else
                            a[++s]++;
                    else
                        a[s]++;
                if (this.foundPatternCross(a))
                    this.handlePossibleCenter(a, o, n) && (r = a[0], this.hasSkipped && (i = this.haveMultiplyConfirmedCenters()))
            }
    ...
    function F(e, t, n, r, i, a, o) {
        this.image = e, this.possibleCenters = new Array, this.startX = t, this.startY = n, this.width = r, this.height = i, this.moduleSize = a, this.crossCheckStateCount = new Array(0, 0, 0), this.resultPointCallback = o, this.centerFromEnd = function(e, t) {
            return t - e[2] - e[1] / 2
        }, this.foundPatternCross = function(e) {
            ...
            var i = this.image, a = A.height, o = this.crossCheckStateCount;
            o[0] = 0, o[1] = 0, o[2] = 0;
            ...
            var r = e[0] + e[1] + e[2], i = this.centerFromEnd(e, n), a = this.crossCheckVertical(t, Math.floor(i), 2 * e[1], r);
            if (!isNaN(a)) {
        ...
        this.blockPointer = 0, this.bitPointer = 7, this.dataLength = 0, this.blocks = e, this.numErrorCorrectionCode = n, t <= 9 ? this.dataLengthMode = 0 : t >= 10 && t <= 26 ? this.dataLengthMode = 1 : t >= 27 && t <= 40 && (this.dataLengthMode = 2), this.getNextBits = function(e) {
            ...
            if (e < this.bitPointer + 1 + 16) {
                ...
                for (r = 0; r < e - (this.bitPointer + 1 + 8); r++)
                    a += 1 << r;
                return a <<= 8 - (e - (this.bitPointer + 1 + 8)), t = o + s + ((this.blocks[this.blockPointer] & a) >> 8 - (e - (this.bitPointer + 1 + 8))), this.bitPointer = this.bitPointer - (e - 8) % 8, this.bitPointer < 0 && (this.bitPointer = 8 + this.bitPointer), t
            }
            return 0
            ...
            do {
                if (t > 1) {
                    ...
                    1 == t && (r += i[n = this.getNextBits(6)], t -= 1)
            } while (t > 0);
            return r
                ...
                if (7 == t)
                    ...
                    switch (t) {
                        case 1:
                            ...
                            break;
                        case 2:
                            for (i = this.getRomanAndFigureString(r), a = new Array(i.length), o = 0; o < i.length; o++)
                                a[o] = i.charCodeAt(o);
                            e.push(a);
                            break;
                        case 4:
    ...
    return A.orderBestPatterns = function(e) {
        ...
        if (o >= a && o >= s ? (r = e[0], n = e[1], i = e[2]) : s >= o && s >= a ? (r = e[1], n = e[0], i = e[2]) : (r = e[2], n = e[0], i = e[1]), function(e, t, n) {
            var r = t.x, i = t.y;
...
var Html5Qrcode = function() {
    ...
    return _createClass(a, [{key: "start", value: function(b, c, d, e) {
                var f = this;
                if (!b)
                ...
                var i = null != h.qrbox, j = document.getElementById(this._elementId), k = j.clientWidth ? j.clientWidth : a.DEFAULT_WIDTH;
                ...
                var m = function(a, b) {
                    ...
                    var d = i && c <= b, e = d ? f._getShadedRegionBounds(a, b, c) : {x: 0, y: 0, width: a, height: b}, k = f._createCanvasElement(e.width, e.height), l = k.getContext("2d");
                    l.canvas.width = e.width, l.canvas.height = e.height, j.append(k), d && f._possiblyInsertShadingElement(j, b, e), g._qrRegion = e, g._context = l, g._canvasElement = k
                }, n = function b() {
                    if (g._shouldScan) {
                        if (g._localMediaStream) {
                            var c = g._videoElement, d = c.videoWidth / c.clientWidth, i = c.videoHeight / c.clientHeight, j = g._qrRegion.width * d, k = g._qrRegion.height * i;
                            g._context.drawImage(g._videoElement, g._qrRegion.x, g._qrRegion.y, j, k, 0, 0, g._qrRegion.width, g._qrRegion.height);
                            try {
                                g.qrcode.decode(), f._possiblyUpdateShaders(!0)
                            } catch (a) {
                ...
                return new Promise(function(a, c) {
                    if (navigator.mediaDevices && navigator.mediaDevices.getUserMedia) {
                        navigator.mediaDevices.getUserMedia({audio: !1, video: {deviceId: {exact: b}}}).then(function(b) {
                            o(b).then(function() {
                                g._isScanning = !0, a()
                            })["catch"](c)
                        })["catch"](function(a) {
                        ...
                        navigator.getUserMedia({video: {optional: [{sourceId: b}]}}, function(b) {
                            o(b).then(function() {
                                g._isScanning = !0, a()
                            })["catch"](c)
                        }, function(a) {
                ...
                return new Promise(function(c) {
                    ...
                    var d = b._localMediaStream.getVideoTracks().length, e = 0, f = function() {
            ...
            }}, {key: "scanFile", value: function(b, c) {
                var d = this;
                ...
                return new Promise(function(f, g) {
                    ...
                    var h = new Image;
                    h.onload = function() {
                        var b = Math.max, i = h.width, j = h.height, k = document.getElementById(d._elementId), l = k.clientWidth ? k.clientWidth : a.DEFAULT_WIDTH, m = b(k.clientHeight ? k.clientHeight : j, a.FILE_SCAN_MIN_HEIGHT), n = e(i, j, l, m);
                        if (c) {
            ...
            }}, {key: "_possiblyInsertShadingElement", value: function(b, c, d) {
                var e = this;
                if (0 != d.x || 0 != d.y) {
                    var f = {};
            ...
            }}, {key: "_createShadedElement", value: function(b, c, d) {
                ...
                return e
            }}, {key: "_insertShaderBorders", value: function(b, c, d) {
                d = parseInt(d);
                var e = this, f = 5, g = 5, h = 40, i = function() {
                ...
                j(k, l), j(m, n)
            }}, {key: "_possiblyUpdateShaders", value: function(b) {
                    ...
                    if (navigator.mediaDevices && navigator.mediaDevices.enumerateDevices && navigator.mediaDevices.getUserMedia)
                        ...
                        var d = function(c) {
                            for (var d, e = [], f = 0; f !== c.length; ++f)
                                d = c[f], "video" === d.kind && e.push({id: d.id, label: d.label});
                            a._log("".concat(e.length, " results found")), b(e)
                        };
                        MediaStreamTrack.getSources(d)
                    } else
                        a._log("unable to query supported devices."), c("unable to query supported devices.")
                })
            }}, {key: "_getTimeoutFps", value: function(a) {
                return 1e3 / a
            }}, {key: "_log", value: function(b) {
...
var Html5QrcodeScanner = function() {
    function a(b, c, d) {
        if (_classCallCheck(this, a), this.elementId = b, this.config = c, this.verbose = !0 === d, !document.getElementById(b))
    ...
    return _createClass(a, [{key: "render", value: function(b, c) {
                var d = this;
                ...
                var d = document.createElement("div"), e = this.__getDashboardId();
                d.id = e, d.style.width = "100%", a.appendChild(d), this.__setupInitialDashboard(d)
            }}, {key: "__resetBasicLayout", value: function(a) {
                a.style.border = "none"
            }}, {key: "__setupInitialDashboard", value: function(a) {
                this.__createSection(a), this.__createSectionControlPanel(), this.__createSectionSwap()
            }}, {key: "__createHeader", value: function(a) {
                var b = document.createElement("div");
            ...
            }}, {key: "__createSection", value: function(a) {
                var b = document.createElement("div");
                b.id = this.__getDashboardSectionId(), b.style.width = "100%", b.style.padding = "10px", b.style.textAlign = "left", a.appendChild(b)
            }}, {key: "__createSectionControlPanel", value: function() {
                var b = this, c = document.getElementById(this.__getDashboardSectionId()), d = document.createElement("div");
                c.appendChild(d);
                var e = document.createElement("div");
                ...
                g.innerHTML = "Request Camera Permissions", g.addEventListener("click", function() {
            ...
            }}, {key: "__renderCameraSelection", value: function(b) {
                var c = this, d = document.getElementById(this.__getDashboardSectionCameraScanRegionId());
                ...
                for (var g = 0; g < b.length; g++) {
                    var h = b[g], j = h.id, k = null == h.label ? j : h.label, l = document.createElement("option");
                    l.value = j, l.innerHTML = k, f.appendChild(l)
                }
                e.appendChild(f), d.appendChild(e);
                var m = document.createElement("span"), n = document.createElement("button");
                ...
                o.innerHTML = "Stop Scanning", o.style.display = "none", o.disabled = !0, m.appendChild(o), d.appendChild(m), n.addEventListener("click", function() {
                    ...
                    var b = c.config ? c.config : {fps: 10, qrbox: 250}, d = f.value;
            ...
            }}, {key: "__createSectionSwap", value: function() {
                var b = this, c = "Scan an Image File", d = "Scan using camera directly", e = document.getElementById(this.__getDashboardSectionId()), f = document.createElement("div");
                f.style.textAlign = "center";
            ...
            }}, {key: "__setStatus", value: function(b, c) {
            ...
            }}, {key: "__resetHeaderMessage", value: function() {
                var a = document.getElementById(this.__getHeaderMessageContainerId());
                a.style.display = "none"
            }}, {key: "__setHeaderMessage", value: function(b, c) {
                c || (c = a.STATUS_DEFAULT);
            ...
            }}, {key: "_showHideScanTypeSwapLink", value: function(a) {
                !0 !== a && (a = !1), this.sectionSwapAllowed = a, this.__getDashboardSectionSwapLink().style.display = a ? "inline-block" : "none"
            }}, {key: "__insertCameraScanImageToScanRegion", value: function() {
                var b = this, c = document.getElementById(this.__getScanRegionId());
            ...
            }}, {key: "__insertFileScanImageToScanRegion", value: function() {
                var b = this, c = document.getElementById(this.__getScanRegionId());
