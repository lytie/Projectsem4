                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="card">
                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h3 class="card-title">List Drink</h3>
                                                    </div>
                                                    <!-- /.card-header -->
                                                    <div class="card-body">
                                                        <table id="example1" class="table table-bordered table-striped">
                                                            ...
                                                            <tbody>
                                                                <c:forEach items="${listdrink}" var="d">
                                                                    <tr>
                                                                        <td><c:out value="${d.getServiceName()}"/></td>
                                                                        <td><c:out value="${d.getServicePrice()}"/></td>
                                                                        <td><c:out value="${d.getServiceDescription()}"/></td>
                                                                        <td width="100"><img src="images/customerpageimg/${d.getServiceurl()}" width="80" height="70" /></td>
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-body">
                                                        <table id="example1" class="table table-bordered table-striped">
                                                            ...
                                                            <tbody>
                                                                <c:forEach items="${listentertainment}" var="e">
                                                                    <tr>
                                                                        <td><c:out value="${e.getServiceName()}"/></td>
                                                                        <td><c:out value="${e.getServicePrice()}"/></td>
                                                                        <td><c:out value="${e.getServiceDescription()}"/></td>
                                                                        <td width="100"><img src="images/customerpageimg/${e.getServiceurl()}" width="80" height="70" /></td>
