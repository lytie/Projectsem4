                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="profile-agent-info">
                            <div class="">
                                <img src="images/review_1_large.jpg" alt="">
                               
                            </div>
                            <div class="pi-text">
                                <h5>Name type room</h5>
                                <span>Location</span>
                                <p>Checkin-checkout date</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="profile-agent-widget">
                            <ul>
                                ...
                                <li>Service2 <span>10 <span>215$</span></span></li>
                                <li>Service1 <span>2 <span>215$</span></span></li>
                                <li>Service2 <span>10 <span>215$</span></span></li>
                                 <li>Service1 <span>2 <span>215$</span></span></li>
                                <li>Service2 <span>10 <span>215$</span></span></li>
                                <li>Service1 <span>2 <span>215$</span></span></li>
                    ...
                    <div class="col-lg-2">
                        <div class="profile-agent-newslatter">
                             <ul>
                                <li>SubTotal: <span>234$</span></li>
                                <li>Tax: <span>215$</span></li>
                                <li>Deposits: <span>215$</span></li>
