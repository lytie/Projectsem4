                                            ...
                                            <div class="select-itms">
                                                <select name="select" id="select3">
                                                    <c:forEach items="${listLocation}" var="lo">
                                                        <option value="">${lo.locationName}</option>
                                                    </c:forEach>
                                                </select>
                                            </div>
                                        </form>
                    ...
                    <div class="col">
                        ...
                        <div class="locations_container d-flex flex-row align-items-start justify-content-between flex-wrap">
                            <c:forEach items="${listLocation}" var="lo">
                                <!-- Location -->
                                <div class="location">
                                    <img src="<%=common.urlImg%>/img/${lo.locationUrl}" alt="" width="100%" height="140">
                                    <div class="location_title text-center">
                                        <div><a href="">${lo.locationName}<div>+</div></a></div>
                                    </div>
                                </div>
                            </c:forEach>
                    ...
                    <c:forEach items="${listType}" var="type">
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6">
                            ...
                            <div class="single-room mb-50">
                                <div class="room-img">
                                    <a><img src="<%=common.urlImg%>/img/${type.url}" alt="" width="100%" height="300"></a>
                                </div>
                                <div class="room-caption">
                                    <h3><a>${type.roomTypeName}</a></h3>
                                    <div class="per-night">
                                        <span><span>${type.description}</span></span>
                                    </div>
                                </div>
                            </div>
                        </div>
