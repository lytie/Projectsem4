    ...
    <body>
		...
		<div class="container-login100">
			<div class="wrap-login100">
					...
					<div class="wrap-input100 validate-input m-b-12" >
                                            <input class="input100" type="email" name="email" placeholder="Email" value="${email}" required=""/>
						<span class="focus-input100"></span>
					</div>
					<div class="m-b-10 fs-12" style="color: red">
					...
					<div class="wrap-input100 validate-input m-b-12" >
                                            <input class="input100" type="text" name="phone" placeholder="Phone" value="${phone}" required=""/>
						<span class="focus-input100"></span>
					</div>
					<div class="m-b-10 fs-12" style="color: red">
					...
					<div class="wrap-input100 validate-input m-b-12">
                                            <input class="input100" type="password" name="passconfirm" placeholder="Confirm password" required=""/>
						<span class="focus-input100"></span>
					</div>
