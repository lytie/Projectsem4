                                        ...
                                        <div class="modal-dialog modal-dialog-scollable modal-xl " >
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <form action="Admin_UpdateRoom" method="post">
                                                        <table style="width: 100%">
                                                            <tr>
                                                                <td rowspan="2">
                                                                    <div style="font-size: 25px;">
                                                                        Price:
                                                                        <div><input value="${l.price}" type="number" name="priceUp" class="form-control"/></div>
                                                                    </div>
                                                            ...
                                                            <tr>
                                                                <td colspan="3">
                                                                    <textarea cols="100" rows="5" class="form-control" name="descriptionUp">${l.description}</textarea>
                                                                </td>
                                                                
                                                            </tr>
                                                            <tr>
                                                                <td><div>Bed Option: <input value="${l.bedOption}" type="text" name="bedUp" class="form-control"/></div></td>
                                                        ...
                                                        <div style="margin-top: 20px; ">
                                                            <div>
                                                                <p id="plus${l.roomId}" style="cursor: pointer;" class="btn btn-outline-primary">Add Image <i class='fas fa-plus' ></i></p> 
                                                            </div>
                                                            <script>
                                                             ...
                                                             <p><label for='file" + count + "' style='cursor: pointer;color: #009900'>Upload Image <i class='fas fa-upload' ></i></label></p>\n\
                                                             <p><img id='output" + count + "' width='200' />\n\
                                                                </p> \n\
                                                             <div id='detele' style='cursor: pointer;color:#CC0000 '>Remove Image <i class='fas fa-trash' ></i></div>\n\
                                                                 <script>\n\
